...
/**
 * v2_taobao_order_detail_info
 * @author 
 */
@ApiModel(value="com.help.rebate.dao.entity.V2TaobaoOrderDetailInfo订单详情表")
@Data
public class V2TaobaoOrderDetailInfo implements Serializable {
    private Integer id;
    ...
    public boolean equals(Object that) {
        ...
        V2TaobaoOrderDetailInfo other = (V2TaobaoOrderDetailInfo) that;
