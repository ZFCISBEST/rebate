...
public class WXPayRequest {
    ...
    public WXPayRequest(com.help.rebate.service.wx.WXPayConfig config) throws Exception{
    ...
    private String request(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean useCert, boolean autoReport) throws Exception {
        ...
        long startTimestampMs = com.help.rebate.service.wx.WXPayUtil.getCurrentTimestampMs();
        ...
        try {
            ...
            elapsedTimeMillis = com.help.rebate.service.wx.WXPayUtil.getCurrentTimestampMs()-startTimestampMs;
            config.getWXPayDomain().report(domainInfo.domain, elapsedTimeMillis, null);
            com.help.rebate.service.wx.WXPayReport.getInstance(config).report(
                    uuid,
                    elapsedTimeMillis,
                    domainInfo.domain,
            ...
            firstHasDnsErr = true;
            elapsedTimeMillis = com.help.rebate.service.wx.WXPayUtil.getCurrentTimestampMs()-startTimestampMs;
            com.help.rebate.service.wx.WXPayUtil.getLogger().warn("UnknownHostException for domainInfo {}", domainInfo);
            com.help.rebate.service.wx.WXPayReport.getInstance(config).report(
                    uuid,
                    elapsedTimeMillis,
                    domainInfo.domain,
            ...
            elapsedTimeMillis = com.help.rebate.service.wx.WXPayUtil.getCurrentTimestampMs()-startTimestampMs;
            com.help.rebate.service.wx.WXPayUtil.getLogger().warn("connect timeout happened for domainInfo {}", domainInfo);
            com.help.rebate.service.wx.WXPayReport.getInstance(config).report(
                    uuid,
                    elapsedTimeMillis,
                    domainInfo.domain,
            ...
            elapsedTimeMillis = com.help.rebate.service.wx.WXPayUtil.getCurrentTimestampMs()-startTimestampMs;
            com.help.rebate.service.wx.WXPayUtil.getLogger().warn("timeout happened for domainInfo {}", domainInfo);
            com.help.rebate.service.wx.WXPayReport.getInstance(config).report(
                    uuid,
                    elapsedTimeMillis,
                    domainInfo.domain,
