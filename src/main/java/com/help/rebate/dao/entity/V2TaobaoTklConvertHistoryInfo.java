...
/**
 * v2_taobao_tkl_convert_history_info
 * @author 
 */
@ApiModel(value="com.help.rebate.dao.entity.V2TaobaoTklConvertHistoryInfo转链记录表")
@Data
public class V2TaobaoTklConvertHistoryInfo implements Serializable {
    private Integer id;
    ...
    public boolean equals(Object that) {
        ...
        V2TaobaoTklConvertHistoryInfo other = (V2TaobaoTklConvertHistoryInfo) that;
